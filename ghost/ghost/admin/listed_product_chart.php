...
<body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        echo "<h3 class='text-center'>Total Listed Products : " . $counter[0] . "</h3>";
                                    ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        echo "<h3 class='text-center'>Total Active Products : " . $counter[0] . "</h3>";
                                    ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        echo "<h3 class='text-center'>Total Blocked Products : " . $counter[0] . "</h3>";
                                    ?>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=listing_products_tot_year",
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=listing_products_tot_months",
            success : function(response){
                var xvalues = 0;
                xvalues = [xvalues].concat(response.xvalues.split(","));
                xvalues.pop();
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=listing_product_chart_actblock",
            success : function(response){
