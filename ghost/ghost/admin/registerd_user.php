        ...
        <div class="layout">
            ...
            <div class="page-container">
                    ...
                    <div class="modal-dialog justify-content-center">
                        <div class="modal-content justify-content-center">
                            ...
                            <div class="modal-body">
                                ...
                                <textarea name="reason" id="reason" placeholder="Enter Reason Here......" class="form-control inpt_minifrm" cols="30" rows="5" ></textarea>
                            </div>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Normal User</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab"   data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Subscribed User</a>
                    </li>
                </ul>
                    ...
                    <div class="tbl_main table-responsive">   
                        <table id="substable" class="table hover">
                                <thead class="thead-dark">
                                    ...
                                    <tbody>
                                    <?php
                                        //this queryis for unregistered user
                                        $query = mysqli_query($con, "SELECT * FROM `user_master` WHERE `id` IN (SELECT `id` FROM `user_master` WHERE DATEDIFF(`expiary_date`, CURRENT_DATE) < 0 OR DATEDIFF(`expiary_date`, CURRENT_DATE) IS NULL) AND `role` = 2");
                        ...
                        <div class="tbl_main table-responsive">      
                            <table id="userTable" class="table hover " >
                                <thead class="thead-dark">
                                    ...
                                    <tbody>
                                    <?php
                                        //this queryis for registered user
                                        $query = mysqli_query($con, "SELECT * FROM `user_master` WHERE `id` IN (SELECT `id` FROM `user_master` WHERE DATEDIFF(`expiary_date`, CURRENT_DATE) > 0) AND `role` = 2");
