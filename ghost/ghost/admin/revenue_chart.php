...
<body>
                ...
                <div class="main-content">
                    <div class="row d-flex justify-content-between align-items-center">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        $query = mysqli_query($con, "SELECT SUM(`subscription_master`.`rate`) FROM `subscription_selling` JOIN `subscription_master` ON `subscription_selling`.`subscription_id` = `subscription_master`.`id`;");
                                        $counter = mysqli_fetch_array($query);

                                        echo "<h3 class='text-center'>Total Subscription Revenue : Rs." . $counter[0] . "</h3>";
                                    ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row d-flex justify-content-between align-items-center mt-5">
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body text-center">
                                    Month Wise Line Chart for Current Year
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=revenue_tot_year",
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=revenue_tot_months",
            success : function(response){
                var xvalues = 0;
                xvalues = [xvalues].concat(response.xvalues.split(","));
                xvalues.pop();
            ...
            success : function(response){
                ...
                new Chart("subs",{
                    ...
                    options : {
                        title : {
                            display : true,
                            text : "Bifurcation of revenue data",
                        }
                    }
                })
            }
