...
<body>
                    ...
                    <div class="tab-content m-t-15" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <select id="year_select" class="form-control mb-5">
                                ...
                                <?php
                                    $query = mysqli_query($con, "SELECT DISTINCT YEAR(`created_at`) FROM `visitor_master`");
    ...
    <script>
        ...
        $("#year_select").change(function(){
            ...
            if(year != "" && year != null)
            {
                ...
                $.ajax({
                    ...
                    data : json,
                    dataType : "JSON",
                    url : "../crud.php?what=getvisitinuserlinechart_month_sel_year",
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=getvisitinuserlinechart",
            success : function(response){
                var xvalues = 0;
                xvalues = [xvalues].concat(response.xvalues.split(","));
                xvalues.pop();
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=getvisitinuserlinechart_month",
            success : function(response){
                $("#year_disp").html(response.year + " Year Data");
                var xvalues = 0;
                xvalues = [xvalues].concat(response.xvalues.split(","));
