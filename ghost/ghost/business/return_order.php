...
<body>
                ...
                <div class="main-content">
                    ...
                    <div class="row d-flex justify-content-between align-items-center">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Current Year Month Wise Return Order</h5>
                    ...
                    <div class="row d-flex justify-content-between align-items-center">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Current Year Product Wise Return Order</h5>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <canvas id="current_year_delivered_orders_product_wise" style="width:100%;max-width:600px;margin: 0 auto;"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $.ajax({
            ...
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=particularBusinessCurrentYearMonthWiseReturnOrder",
            success : function(response){
                var xvalues = 0;
                xvalues = [xvalues].concat(response.xvalues.split(","));
                xvalues.pop();
        ...
        //Current year product wise return 
        $.ajax({
            type : "POST",
            method : "POST",
            dataType : "JSON",
            url : "../crud.php?what=particularBusinessCurrentYearProductWiseReturnOrder",
            success : function(response){
                var xvalues = 0;
                xvalues = [xvalues].concat(response.xvalues.split(","));
                xvalues.pop();
                ...
                yvalues = [yvalues].concat(response.yvalues.split(","));
                yvalues.pop();
                new Chart("current_year_delivered_orders_product_wise", {
                    type: "line",
                    data: {
                        labels: xvalues,
                        datasets: [{
