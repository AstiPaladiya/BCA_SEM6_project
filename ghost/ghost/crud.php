<?php
    ...
    if($_GET["what"] == "blockcustomer")
    {
        ...
        $to = $result[1];
        mail($to, $subject, $message, "From:Ghost Marketer");
    ...
    if($_GET['what'] == "blunblproduct")
    {
        ...
        if($query != 0)
        {
            ...
            mail($getmail[0], "Product ". $_POST['do'] ." by Admin", $message, "From:Ghost Marketer");
            $response['success'] = true;
    ...
    if($_GET['what'] == "getuserbifurcation")
        ...
        if($_GET['what'] == "sendbusotp")
        {
            ...
            {
                $otp = rand(100000, 999999);
                mail($_POST['email'], "OTP for password reset", "Dear User " . $_POST['email'] . ",\n\nYour OTP for reseting your password is $otp", "From:Ghost Marketer");
                $response['success'] = true;
        ...
        if($_GET['what'] == "changeReturnOrderStatus")
        {
            ...
            if($query > 0)
            {
                if($_POST['do'] == "Picked Up" || $_POST['do'] == "Completed" || $_POST['do'] == "Accepted")
                {
                    ...
                    mail($result[1], $subject, $message, "From:Ghost Marketer");
                }
                $response['success'] = true;
    ...
    if($_GET['what']=="insertMarketer")
    {
        ...
        else
        {
            ...
            if($query != 0)
            {
                ...
                mail($mail, $subject, $message, "From:Ghost Marketer");
                $response['success'] = true;
    ...
    if($_GET['what']=="assignProduct")
    {
        ...
        if($result[0] == 0)
        {
            ...
            if($query != 0)
            {
                ...
                mail($result['email'], $subject, $message, "From:Ghost Marketer");
                $response['success'] = true;
