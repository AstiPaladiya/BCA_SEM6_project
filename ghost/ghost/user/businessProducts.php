				...
				if($("#price_range").val() != "" && $("#price_range").val() != null)
				{
					...
					switch(selectedRange)
					{
						case "1" :
							...
							window.location.href = "businessProducts.php?priceFilter=1";
							break;
						case "2" :
							$("#value-lower").html("101");
							$("#value-upper").html("300");

							window.location.href = "businessProducts.php?priceFilter=2";
							break;
						case "3" :
							$("#value-lower").html("301");
							$("#value-upper").html("500");

							window.location.href = "businessProducts.php?priceFilter=3";
							break;
						case "4" :
							$("#value-lower").html("501");
							$("#value-upper").html("1000");

							window.location.href = "businessProducts.php?priceFilter=4";
							break;
						case "5" :
							$("#value-lower").html("1001");
							$("#value-upper").html("Max");

							window.location.href = "businessProducts.php?priceFilter=5";
							break;
						case "all":
							$.ajax({
								type : "POST",
							...
							window.location.href = "businessProducts.php?priceFilter=all";
							break;
					}
				}
			})
