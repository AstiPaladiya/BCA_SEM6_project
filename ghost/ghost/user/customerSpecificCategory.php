						...
						<div class="row" >
							<?php
								if(isset($_GET['priceFilter']))
								{
                                    ...
                                    $queryString .= " and catagory_id = ". $_GET['id'] ."";
											...
											while($row_user=mysqli_fetch_array($query_user))
											{
												...
												else
												{
													// User product
														...
														{
															$query_sessuser=mysqli_query($con,"select * from user_master where id=".$_SESSION['front_user_id']." and status = 'active'");
								...
								{
									$query=mysqli_query($con,"select * from listing_products where product_status='Active' and catagory_id = ". $_GET['id'] ."");
									while($row=mysqli_fetch_array($query))
									{
										if($row['sell_status']=='Unsold')
										{
...
<script type="text/javascript" src="js/jquery.simplePagination.js"></script>
	...
	<script>
				...
				if($("#price_range").val() != "" && $("#price_range").val() != null)
				{
					...
					switch(selectedRange)
					{
						case "1" :
							...
							// window.location.href = "specificCategory.php?priceFilter=1";
							window.location.href = window.location.href + "&priceFilter=1";
							break;
						case "2" :
							$("#value-lower").html("101");
							$("#value-upper").html("300");

							// window.location.href = "specificCategory.php?priceFilter=2";
							window.location.href = window.location.href + "&priceFilter=2";
							break;
						case "3" :
							$("#value-lower").html("301");
							$("#value-upper").html("500");

							// window.location.href = "specificCategory.php?priceFilter=3";
							window.location.href = window.location.href + "&priceFilter=3";
							break;
						case "4" :
							$("#value-lower").html("501");
							$("#value-upper").html("1000");

							// window.location.href = "specificCategory.php?priceFilter=4";
							window.location.href = window.location.href + "&priceFilter=4";
							break;
						case "5" :
							$("#value-lower").html("1001");
							$("#value-upper").html("Max");

							// window.location.href = "specificCategory.php?priceFilter=5";
							window.location.href = window.location.href + "&priceFilter=5";
							break;
						case "all":
							$.ajax({
								type : "POST",
							...
							// window.location.href = "specificCategory.php?priceFilter=all";
							window.location.href = window.location.href + "&priceFilter=all";
							break;
					}
				}
			})
		...
		// $("#businessCategory option:eq(1)").prop("selected", true);
		// console.log(params.get("id"));
		$(`#customerCategory`).val(params.get("id"));
	</script>
